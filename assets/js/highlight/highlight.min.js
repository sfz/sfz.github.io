/*!
  Highlight.js v11.2.0 (git: f8b4434171)
...
t.data._beginMatch!==e[1]&&t.ignoreMatch()}})});function M(e,t){
...
;return(e=>{const t=Object.create(null),r=Object.create(null),s=[];let o=!0
...
let y={};function w(t,s){const a=s&&s[0];if(R+=t,null==a)return d(),0
...
;e.forEach((e=>S.openNode(e)))})();let R="",M=0,A=0,j=0,I=!1;try{
...
;A=e.index+t}return w(n.substr(A)),S.closeAllNodes(),S.finalize(),O=S.toHTML(),{
language:e,value:O,relevance:M,illegal:!1,_emitter:S,_top:k}}catch(t){
